...
/** CHECKS_SEED_LIST.md HOOK #6 — native-layer, see DECISIONS.md D002. */
class TrampolineHookCheck : ThreatCheck {
    override val id: String = "hook.trampoline_inline_hook"
    ...
    override fun evaluate(context: CheckContext): CheckResult =
        CheckResult(id, category, severity, detected = NativeBridge.trampolineHookDetected())
}
